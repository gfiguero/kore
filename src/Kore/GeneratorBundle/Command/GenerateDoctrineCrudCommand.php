...
namespace Kore\GeneratorBundle\Command;
...
use Kore\GeneratorBundle\Generator\DoctrineCrudGenerator;
use Kore\GeneratorBundle\Command\Validators;
...
class GenerateDoctrineCrudCommand extends BaseGenerateDoctrineCrudCommand
{
    ...
    {
        $this
            ->setName('kore:generate:crud')
            ->setAliases(array('kore:doctrine:crud'))
