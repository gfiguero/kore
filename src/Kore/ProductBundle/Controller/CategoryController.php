...
use Kore\ProductBundle\Entity\Category;
use Kore\ProductBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $categories = $em->getRepository('KoreProductBundle:Category')->findBy(array(), array($sort => $direction));
        else $categories = $em->getRepository('KoreProductBundle:Category')->findAll();
        ...
        return $this->render('KoreProductBundle:Category:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreProductBundle:Category:new.html.twig', array(
    ...
    {
        return $this->createForm('Kore\ProductBundle\Form\CategoryType', $category, array(
    ...
    public function showAction(Category $category)
    {
        ...
        return $this->render('KoreProductBundle:Category:show.html.twig', array(
            'category' => $category,
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        return $this->render('KoreProductBundle:Category:edit.html.twig', array(
            'category' => $category,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
