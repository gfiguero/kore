...
use Kore\ProductBundle\Entity\Subcategory;
use Kore\ProductBundle\Form\SubcategoryType;
...
class SubcategoryController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $subcategories = $em->getRepository('KoreProductBundle:Subcategory')->findBy(array(), array($sort => $direction));
        else $subcategories = $em->getRepository('KoreProductBundle:Subcategory')->findAll();
        ...
        return $this->render('KoreProductBundle:Subcategory:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($newForm->isSubmitted()) {
            if($newForm->isValid()) {
                ...
                return $this->redirect($this->generateUrl('subcategory_index'));
            }
        }

        return $this->render('KoreProductBundle:Subcategory:new.html.twig', array(
    ...
    {
        return $this->createForm('Kore\ProductBundle\Form\SubcategoryType', $subcategory, array(
    ...
    public function showAction(Subcategory $subcategory)
    {
        ...
        return $this->render('KoreProductBundle:Subcategory:show.html.twig', array(
    ...
    public function editAction(Request $request, Subcategory $subcategory)
    {
        ...
        return $this->render('KoreProductBundle:Subcategory:edit.html.twig', array(
            'subcategory' => $subcategory,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm('Kore\ProductBundle\Form\SubcategoryType', $subcategory, array(
            'action' => $this->generateUrl('subcategory_edit', array('id' => $subcategory->getId())),
        ));
    }
